    ...
    <div class="row g-0 min-vh-100">
      ...
      <div class="col-lg-6 d-none d-lg-block">
        <div class="image-container">
          <img
            src="https://images.unsplash.com/photo-1721264532439-a4f1bb8448f1?q=80&w=1036&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        ...
        <div class="form-container">
          <div class="register-card">
            <div class="card-header-custom">
              <h3>Register</h3>
              <p class="text-muted">Create your new account to get started</p>
            </div>

            <div class="card-body-custom">
              <form @submit.prevent="register">
                <div class="form-row">
                  <div class="form-group-custom form-group-half">
                ...
                <div v-if="registerError" class="alert-custom">
                  {{ registerError }}
                </div>
              </form>
...
.form-group-custom:nth-of-type(2) {
  animation-delay: 0.2s;
}

.form-group-custom:nth-of-type(3) {
  animation-delay: 0.3s;
}

.form-group-custom:nth-of-type(4) {
